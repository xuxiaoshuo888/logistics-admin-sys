  ...
  export default {
    ...
    methods: {
      ...
      toEdit(e) {//打开编辑模态框
        ...
        this.form.furniture_category = JSON.parse(e.furniture_category);
        this.jjpl = JSON.parse(e.furniture_category);
      ...
      change_jjpl(e) {//家具品类change回调
        ...
        this.form.furniture_category = JSON.stringify(this.jjpl);
      },
